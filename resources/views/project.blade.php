    ...
    <div class="container">
        <div class="row gy-4">
            ...
            @php
                $projectsData = [
                    [
                        'title' => 'Gedung Perkantoran Harmoni',
                        'category' => 'Konstruksi Bangunan',
                        'image' => 'images/projects/villa-nusa-dua (2).jpeg', // Gunakan gambar sementara
                        'description' => 'Pembangunan kompleks perkantoran modern dengan desain minimalis dan fungsional di pusat kota. Proyek ini mengedepankan efisiensi energi dan ruang kerja yang nyaman.',
                        'aos_delay' => '100'
                    ],
                    [
                        'title' => 'Renovasi Resor Nusa Indah',
                        'category' => 'Renovasi & Hospitality',
                        'image' => 'images/projects/villa-nusa-dua (2).jpeg', // Gunakan gambar sementara
                        'description' => 'Penyelesaian renovasi total untuk resor bintang lima di kawasan pariwisata Bali, menghadirkan suasana baru yang lebih modern namun tetap mempertahankan nuansa lokal.',
                        'aos_delay' => '200'
                    ],
                    [
                        'title' => 'Proyek Tol Cepat Raya',
                        'category' => 'Infrastruktur',
                        'image' => 'images/projects/villa-nusa-dua (2).jpeg', // Gunakan gambar sementara
                        'description' => 'Kontribusi dalam pembangunan ruas jalan tol baru yang menghubungkan dua kota besar, memperlancar distribusi dan pergerakan ekonomi regional.',
                        'aos_delay' => '300'
                    ],
                    [
                        'title' => 'Desain Kafe Kopi Senja',
                        'category' => 'Desain Interior',
                        'image' => 'images/projects/villa-nusa-dua (2).jpeg', // Gunakan gambar sementara
                        'description' => 'Perancangan ulang interior kafe dengan konsep urban-industrial yang nyaman dan estetis, menarik lebih banyak pengunjung muda.',
                        'aos_delay' => '400'
                    ],
                    [
                        'title' => 'Gudang Logistik Cepat',
                        'category' => 'Bangunan Industri',
                        'image' => 'images/projects/villa-nusa-dua (2).jpeg', // Gunakan gambar sementara
                        'description' => 'Pembangunan gudang logistik canggih dengan sistem manajemen stok terintegrasi, mendukung operasional rantai pasok yang efisien.',
                        'aos_delay' => '500'
                    ],
                    [
                        'title' => 'Restorasi Cagar Budaya',
                        'category' => 'Konservasi & Restorasi',
                        'image' => 'images/projects/villa-nusa-dua (2).jpeg', // Gunakan gambar sementara
                        'description' => 'Proyek restorasi cermat pada bangunan cagar budaya, mengembalikan keindahan arsitektur aslinya sambil memastikan kekokohan struktur.',
                        'aos_delay' => '600'
                    ],
                ];
            @endphp
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $project['aos_delay'] }}">
                <div class="project-item">
                    ...
                    <div class="project-info">
                        <h4>{{ $project['title'] }}</h4>
                        <p class="project-category">Kategori: {{ $project['category'] }}</p>
